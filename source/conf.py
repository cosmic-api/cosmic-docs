...
project = u'Cosmic Spec'
copyright = u'2013, 8313547 Canada Inc.'
...
# documentation.
html_theme_options = {
    "github_url": "https://github.com/cosmic-api/cosmic-docs"
}
...
latex_documents = [
  ('index', 'Cosmic.tex', u'Cosmic Documentation',
   u'Alexei Boronine, Kyu Lee', 'manual'),
]
...
texinfo_documents = [
  ('index', 'Cosmic', u'Cosmic Documentation',
   u'Alexei Boronine, Kyu Lee', 'Cosmic', 'One line description of project.',
   'Miscellaneous'),
]
